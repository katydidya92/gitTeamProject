...
public class Paging {
	...
	private int dbStartNum; // db 조회 (시작번호)
	private int dbEndNum; // db 조회 (종료번호)
	...
	public int getDbStartNum() {
		return dbStartNum;
	}

	public void setDbStartNum(int dbStartNum) {
		this.dbStartNum = dbStartNum;
	}

	public int getDbEndNum() {
		return dbEndNum;
	}

	public void setDbEndNum(int dbEndNum) {
