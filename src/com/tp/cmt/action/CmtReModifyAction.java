...
public class CmtReModifyAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {

		System.out.println("C : CmtReModifyAction_execute() 실행");
		...
		System.out.println("cmt_content : " + request.getParameter("cmt_content"));
		cb.setBbsID(bbsID);
		cb.setCmtID(cmtID);
		cb.setUserID(userID);
		cb.setCmt_content(request.getParameter("cmt_content"));
		System.out.println(cb);
		cmtao.modifyReCmt(cb);
