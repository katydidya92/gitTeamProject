   ...
   $(function(){
      ...
      $("#alert-danger").hide(); 
	   ...
	   function openIdChk(){
		...
		// 다시 중복체크를 하도록 한다.
		function inputIdChk(){
			document.fr.nickDuplication.value ="idUncheck";
		}
		...
		//이메일 형식제어
		 ...
		 if(fr.emailDuplication.value != "emailCheck"){
...
<body>
  ...
  <form action="./UserJoinAction.tp" method="post" name="fr" onsubmit="return check();" enctype="multipart/form-data">
    <table border="1">
      <tr>
      ...
      <tr>
        <td colspan="2">
          <input type="button" value="취소" onclick="location.href='UserLogin.tp'">
