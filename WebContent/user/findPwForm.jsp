...
<body class="findpw-page ">
	...
	<div class="member-join">
		...
		<form action="./MemberFindPwEmailAction.do" method="post" onsubmit="return check();">
	     ...
	     <input type="button" class="btn btn-primary" value="로그인" onclick="location.href='./UserLogin.do'">
     	 </div>
     </form>
