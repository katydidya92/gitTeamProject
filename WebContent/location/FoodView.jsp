...
<body>
	...
	<script>
		...
		xmlHttp.open("POST", "${contextPath }/bs_resaurant.xml", true); // post 형식으로 web2.xml을 사용하겠습니다.
				...
				if (uc_seq == Attraction[i].getElementsByTagName("UC_SEQ")[0].childNodes[0].nodeValue) {
					result += "<h4 class='tit'>"
						...
						+ "</h4><hr><section id='section1' class='innerwrap'><div class='mainSlider'><img src="
							...
							+ Attraction[i].getElementsByTagName("MAIN_TITLE")[0].childNodes[0].nodeValue
							+ "<br><br><p class='font-size20 medium' style='color: coral;'>주소 </p>"
							+ Attraction[i].getElementsByTagName("ADDR1")[0].childNodes[0].nodeValue
							+ "<br><br><p class='font-size20 medium' style='color: coral;'>전화번호 </p>"
							+ Attraction[i].getElementsByTagName("CNTCT_TEL")[0].childNodes[0].nodeValue
							+ "<br><br><p class='font-size20 medium' style='color: coral;'>영업시간 </p>"
							+ Attraction[i].getElementsByTagName("USAGE_DAY_WEEK_AND_TIME")[0].childNodes[0].nodeValue
							+ "<br><br><p class='font-size20 medium' style='color: coral;'>메뉴 </p>"
							+ Attraction[i].getElementsByTagName("RPRSNTV_MENU")[0].childNodes[0].nodeValue
							+ "<br><br><p class='font-size20 medium' style='color: coral;'>소개 </p>"
