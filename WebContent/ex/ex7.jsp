...
function displayData(xmlHttp) { // xmlHttp를 매개변수로 사용하는 객체
	...
	cityList = xmlObj.getElementsByTagName("item"); // item 태그의 내용을 cityList로 사용.
		result += "<div>"
				+"<img src=" +cityList[1].getElementsByTagName("MAIN_IMG_NORMAL")[0].childNodes[0].nodeValue 
				+ " width='100' height='100'><div class = 'vTab01 boxing'>"
				+ cityList[1].getElementsByTagName("MAIN_TITLE")[0].childNodes[0].nodeValue+"<br>"
				+ cityList[1].getElementsByTagName("ITEMCNTNTS")[0].childNodes[0].nodeValue+"</div>";
